...
public class UtilityBB {
	...
	public static String readProperty(String key) throws Exception {
		String projectPath = System.getProperty("C:\\Users\\Admin\\eclipse-workspace\\capstone.BestBuy\\src\\main\\java\\Resource\\BestBuydata.properties");
		File file = new File(projectPath + "\\BestBuydata.properties");//eclipse-workspace\capstone.BestBuy\src\main\java\Resource\BestBuydata.properties
...
//			options.addArguments("--headless");
	...
	public static Object[][] dataReader(String sheetName) throws IOException {
        String excelPath = System.getProperty("\\Resource\\BestBuydata.properties");
        FileReader excelFile = new FileReader(excelPath + "\\Excel\\BestBuydata.xlsx");
...
//	}
	...
	public static int screenShot(String testName) throws Exception {
		...
		//FileUtils.CopyFile(((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE),
				new File(projectPath + "\\Screenshots\\" +testName+ ranNum + ".png");
		return ranNum;
	}
	...
	public void reportStep(String stepDetails, String stepStatus, String testName) throws Exception {
		...
		String projectPath = System.getProperty("C:\\Users\\Admin\\eclipse-workspace\\capstone.BestBuy\\Excel\\BestBuydata.xlsx");
		if (stepStatus.equalsIgnoreCase("pass")) {
			test.pass(stepDetails,//C:\Users\Admin\eclipse-workspace\capstone.BestBuy\Screenshots
					MediaEntityBuilder.createScreenCaptureFromPath(projectPath + "\\Screenshots\\" +testName+ ranNum + ".png").build());
